...
export function LoginScreen() {
    ...
    const uniforms = {
      ...
      u_colors: {
        value: [
          ...
          new THREE.Vector3(1, 1, 1),
          new THREE.Vector3(0.62, 0.72, 1.0),
          new THREE.Vector3(1, 1, 1),
          new THREE.Vector3(0.42, 0.55, 1.0),
          new THREE.Vector3(1, 1, 1),
        ],
      },
  ...
  const Footer = (
    <div style={{ marginTop: '0.85rem', fontSize: '0.75rem', color: '#666', lineHeight: 1.5, textAlign: 'center' }}>
      By continuing, you agree to UmbraOS
      <br />
  ...
  const CTA = (
    ...
    >
      {isLoading ? <span className="inline-block w-4 h-4 rounded-full border-2 border-white/30 border-t-white animate-spin" /> : mode === 'signin' ? 'Sign in' : 'Create account'}
    </button>
  );
      ...
      >
        {mode === 'signin' ? (
          <div style={{ width: '100%', maxWidth: 360, display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
            {Logo}
            <h1 style={{ fontSize: '1.35rem', fontWeight: 600, marginBottom: '0.25rem', letterSpacing: '-0.025em' }}>Sign in to Umbra</h1>
            <p style={{ fontSize: '0.85rem', color: '#888', marginBottom: '0.85rem', lineHeight: 1.5 }}>Your second brain, everywhere.</p>
            ...
            <button type="button" onClick={handleForgot} disabled={isLoading} style={{ marginTop: '0.4rem', alignSelf: 'flex-end', fontSize: '0.75rem', color: '#888', background: 'none', border: 'none', padding: 0, cursor: 'pointer', fontFamily: 'inherit' }}>
              Forgot password?
            </button>
            ...
            <button type="button" onClick={socialNotReady} style={{ ...socialBtn, marginBottom: 0 }}>
              {AppleIcon}Continue with Apple
            </button>

            <div style={{ marginTop: '1.25rem', fontSize: '0.875rem', color: '#888' }}>
              Don't have an account?{' '}
              <button onClick={() => switchMode('signup')} style={{ color: '#fff', fontWeight: 500, background: 'none', border: 'none', padding: 0, cursor: 'pointer', fontFamily: 'inherit', fontSize: 'inherit' }}>
                Sign Up
              </button>
            </div>
            {Footer}
          ...
          <div style={{ width: '100%', maxWidth: 360, display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
            {Logo}
            <h1 style={{ fontSize: '1.35rem', fontWeight: 600, marginBottom: '0.25rem', letterSpacing: '-0.025em' }}>Sign up for Umbra</h1>
            <p style={{ fontSize: '0.85rem', color: '#888', marginBottom: '0.85rem', lineHeight: 1.5 }}>Create your account to get started.</p>
            ...
            <div style={{ marginTop: '1.25rem', fontSize: '0.875rem', color: '#888' }}>
              ...
              <button onClick={() => switchMode('signin')} style={{ color: '#fff', fontWeight: 500, background: 'none', border: 'none', padding: 0, cursor: 'pointer', fontFamily: 'inherit', fontSize: 'inherit' }}>
                Sign In
              </button>
            </div>
            {Footer}
